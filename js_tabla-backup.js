...
function mostrar(objetojson) {
   
    for (let dato of objetojson) {
        tabla.innerHTML += "<tr><td>" + dato.juego + "</td><td>" + dato.memoria + "</td><td>" + dato.cpu + "</td><td>" + dato.gpu + `</td><td><button data-id=${dato.id} class='btn-editar'>Editar</button></td><td><button data-id=${dato.id} class='btn-eliminar'>Eliminar</button></td></tr>`;
    }
